...
![Generative interference field](assets/hero.webp)

<sub>Three wave sources, no coordination between them, and the pattern in the middle belongs to
none of them. Generated by [`assets/hero.py`](assets/hero.py) from a single seed —
[`hero.svg`](assets/hero.svg) is the vector original.</sub>
